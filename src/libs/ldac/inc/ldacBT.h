...
/* Select an arbitrary target bit rate in kbps. The encoder chooses the
 * closest frame length supported at the configured sampling frequency and
 * ldacBT_get_bitrate() returns the resulting rate.
 */
