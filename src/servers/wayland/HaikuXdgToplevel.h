...
class WaylandWindow;
class BWindow;
class HaikuZxdgToplevelDecoration;
...
private:
	...
	friend class HaikuZxdgToplevelDecoration;

	HaikuXdgSurface *fXdgSurface{};
	WaylandWindow *fWindow{};
	HaikuZxdgToplevelDecoration *fZxdgDecoration{};
...
public:
	...
	void SetZxdgDecoration(HaikuZxdgToplevelDecoration* decor) { fZxdgDecoration = decor; }
	bool HasZxdgDecoration() const { return fZxdgDecoration != NULL; }
	HaikuZxdgToplevelDecoration* ZxdgDecoration() const { return fZxdgDecoration; }
